...
jQuery.sap.declare("sap.custom.routing.Router");
...
jQuery.sap.registerModulePath('sap.custom.routing.Route', 'components/RouteCustom/');
jQuery.sap.require("sap.custom.routing.Route");
